...
export default function ContactForm({ compact = false }) {
    ...
    return (
      <div className="card p-8 text-center">
        ...
        <p className="text-stone-500 text-sm max-w-sm mx-auto">
          Thank you for reaching out. Dr. Gurudeva's team will respond within 24
          hours.
        </p>
      </div>
    );
  ...
  return (
    ...
    >
      <div
        className={`grid gap-5 ${compact ? "grid-cols-1" : "sm:grid-cols-2"}`}
      >
        <div>
        ...
        <div>
          <label htmlFor="email" className="form-label">
            Email Address <span className="text-maroon-500">*</span>
          </label>
          <input
            id="email"
            name="email"
      ...
      <div>
        <label htmlFor="message" className="form-label">
          Your Message <span className="text-maroon-500">*</span>
        </label>
        <textarea
          id="message"
          name="message"
