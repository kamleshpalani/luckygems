          ...
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <Link to="/" className="flex items-center gap-2.5 group flex-shrink-0">
              ...
              <div className="leading-none">
                ...
                <div className="text-[10px] text-purple-400 tracking-[0.15em] uppercase font-sans">
                  Vedic Astrologer
                </div>
              </div>
            </Link>
            ...
            <div className="hidden lg:flex items-center gap-3">
              ...
              <Link to="/inquiry" className="btn-outline !py-2 !px-4 !text-xs hidden xl:inline-flex">
                Request Reading
              </Link>
