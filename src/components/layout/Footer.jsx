    ...
    >
      ...
      <div className="relative">
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, transparent 0%, rgba(201,150,12,0.35) 25%, rgba(201,150,12,0.65) 50%, rgba(201,150,12,0.35) 75%, transparent 100%)",
          }}
        />
        <div
          className="absolute left-1/2 -translate-x-1/2 -top-[5px] w-2.5 h-2.5 rotate-45"
          style={{
            background: "rgba(201,150,12,0.65)",
            boxShadow: "0 0 8px rgba(201,150,12,0.5)",
          }}
        />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-10">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-2">
            ...
            <p className="text-sm text-stone-400 leading-relaxed mb-6 max-w-xs">
              Trusted Vedic astrology consultations for over two decades,
            ...
            <Link
              to="/book"
              className="btn-gold !text-xs !py-2.5 !px-5 mt-6 inline-flex"
            >
              <Sparkles size={12} />
          ...
          {Object.entries(FOOTER_LINKS).map(([group, links]) => (
            <div key={group}>
              <h3 className="text-white font-semibold text-sm mb-4 gradient-text-gold">
                {group}
              </h3>
        ...
        >
          <p className="text-[10px] text-stone-600 mb-3 uppercase tracking-[0.14em]">
            Also serving
          </p>
      ...
      <div style={{ borderTop: "1px solid rgba(255,255,255,0.05)" }}>
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-stone-600 text-center sm:text-left">
            © {new Date().getFullYear()} Gurudev Astrology. All rights reserved.
          </p>
