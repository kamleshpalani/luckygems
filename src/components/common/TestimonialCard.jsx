  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ fontSize: '7rem', lineHeight: 1, color: 'rgba(201,150,12,0.08)' }}
      >
        “
      </div>
      ...
      <div
        ...
        style={{ borderTop: '1px solid rgba(139,26,26,0.07)' }}
      >
        <div
        ...
        <div>
          <p className="font-semibold text-maroon-900 text-sm">{testimonial.name}</p>
          <p className="text-stone-400 text-xs mt-0.5">{testimonial.location} · {testimonial.service}</p>
        </div>
      </div>
    </motion.div>
  );
