...
const BUY_FAQS = [
  {
    q: "Are the gemstones natural and certified?",
    a: "Yes. All gemstones sourced through Dr. Gurudeva are natural, untreated, and come with certification from reputable gemological labs.",
  },
  {
    q: "Can I buy a stone somewhere else?",
    a: "Yes. You can purchase from any reputable certified source. Dr. Gurudeva will still advise on the quality, weight, and specifications required for your chart.",
  },
  {
    q: "Do I need a consultation before buying?",
    a: "Absolutely. A proper Vedic chart analysis must precede any gemstone purchase. Dr. Gurudeva does not recommend gemstones without this step.",
  },
  {
    q: "What if the gemstone is too expensive for me?",
    a: "There are affordable substitute stones for most planetary gemstones. Dr. Gurudeva will advise you on effective alternatives within your budget.",
  },
];
...
const PRICE_RANGES = [
  {
    ...
    planet: "Sun",
    range: "$50–$500+",
    note: "Per carat, natural Burmese preferred",
  },
  {
    gem: "Pearl (Moti)",
    planet: "Moon",
    range: "$20–$200+",
    note: "Natural saltwater, not freshwater",
  },
  {
    gem: "Red Coral (Moonga)",
    planet: "Mars",
    range: "$30–$300+",
    note: "Italian or Japanese origin",
  },
  {
    gem: "Emerald (Panna)",
    planet: "Mercury",
    range: "$100–$1,000+",
    note: "Colombian quality preferred",
  },
  {
    gem: "Yellow Sapphire (Pukhraj)",
    planet: "Jupiter",
    range: "$100–$800+",
    note: "Ceylon (Sri Lanka) origin",
  },
  {
    gem: "Diamond / White Sapphire",
    planet: "Venus",
    range: "$80–$500+",
    note: "White Sapphire is a common substitute",
  },
  {
    gem: "Blue Sapphire (Neelam)",
    planet: "Saturn",
    range: "$200–$2,000+",
    note: "Most powerful — requires precise prescription",
  },
  {
    gem: "Hessonite (Gomed)",
    planet: "Rahu",
    range: "$20–$150+",
    note: "Ceylon or African origin",
  },
  {
    gem: "Cat's Eye (Lahsuniya)",
    planet: "Ketu",
    range: "$30–$300+",
    note: "Chrysoberyl cat's eye",
  },
];
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-stone-300 text-lg leading-relaxed mb-6">
              Every gemstone sourced through Dr. Gurudeva is natural, certified,
              and prescribed only after a thorough analysis of your Vedic birth
              chart.
            </p>
            <div className="flex flex-wrap gap-3">
              <Link
                to="/book?service=gemstone-consultation"
                className="btn-gold"
              >
        ...
        <div className="max-w-3xl mx-auto text-center">
          <div className="card-gold p-7">
            ...
            <h2 className="font-serif text-xl font-semibold text-stone-900 mb-3">
              Consultation Before Purchase — Always
            </h2>
            <p className="text-stone-600 leading-relaxed">
              Gemstone therapy requires precision. Dr. Gurudeva will first
              analyze your Lagna, functional benefics, and malefic planets
              before recommending any stone. Wearing the wrong gemstone can
              strengthen a malefic planet and cause harm. This step is
              mandatory, not optional.
            </p>
            <Link
              to="/services/lucky-gem-report"
              className="btn-primary mt-5 inline-flex"
            >
              Get Your Lucky Gem Report
            </Link>
          </div>
        </div>
      </SectionWrapper>
      ...
      <SectionWrapper variant="white">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-center text-stone-500 text-xs mt-5 border-t border-stone-200 pt-5">
            Gemstones must be natural and without any astrological doshas as per
            Indian Vedic astrology. Only natural, untreated stones are used. No
            extra charge is collected for the above procedure — it is included
            in the gemstone price.
          </p>
        </div>
      </SectionWrapper>
      ...
      <SectionWrapper variant="ivory">
        <div className="max-w-3xl mx-auto">
          <SectionHeader
            ...
            title="Approximate Price Ranges"
            subtitle="Prices vary significantly by origin, treatment status, and quality. Final pricing is determined after consultation."
          />
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b-2 border-gold-300">
                  <th className="text-left py-2 pr-4 font-semibold text-stone-700">
                    Gemstone
                  </th>
                  <th className="text-left py-2 pr-4 font-semibold text-stone-700">
                    Planet
                  ...
                  <th className="text-left py-2 font-semibold text-stone-700">
                    Notes
                  </th>
                </tr>
              </thead>
              <tbody>
                {PRICE_RANGES.map(({ gem, planet, range, note }) => (
                  ...
                  >
                    ...
                    <td className="py-2.5 pr-4 text-maroon-700 font-medium">
                      {range}
                    </td>
      ...
      <CTASection
        ...
        primaryCTA={{
          label: "Book Gemstone Analysis",
          href: "/book?service=gemstone-consultation",
        }}
